      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8">
          ...
          className="space-y-6 mb-5">
            ...
            {/* Name */}
         <Input type="name " placeholder="Enter Your Name" autoComplete="name" label="name" register={register} name="name" 
         rules={
          {
         ...
         />
            ...
            {/* Email */}
          <Input type="email" placeholder="Enter Your Email" autoComplete="email" label="Email" register={register} name="email" 
          rules={{
          ...
          />
            ...
            {/* Button */}
           <Button text="Register as a Admin"/>
          </form>
